...
import { Layers, Plus, Edit, Trash2, Package, DollarSign, AlertTriangle } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm flex items-center justify-between">
          <div>
            ...
            <h3 className="text-2xl font-bold text-emerald-600 font-mono mt-1">${totalValuation.toLocaleString(undefined, { minimumFractionDigits: 2 })}</h3>
          </div>
            ...
            <div key={c._id} className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm flex flex-col justify-between space-y-4 hover:shadow-md transition group">
              ...
              <div className="pt-4 border-t border-slate-100 grid grid-cols-3 gap-2 text-center text-xs font-mono">
                ...
                <div className="bg-slate-50 p-2 rounded-xl border border-slate-100">
                  ...
                  <strong className="text-emerald-600">${(c.totalInventoryValue || 0).toLocaleString()}</strong>
                </div>
