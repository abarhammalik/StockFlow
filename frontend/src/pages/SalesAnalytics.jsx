...
import { TrendingUp, PieChart, ArrowUpRight, Percent, Award, ShieldAlert } from 'lucide-react';
import { 
  BarChart, 
  Bar, 
  XAxis, 
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
          ...
          <h3 className="text-2xl font-bold text-emerald-600 font-mono mt-2">
            ₹{(summary.totalDiscountsGiven || 0).toLocaleString('en-IN', { minimumFractionDigits: 2 })}
          </h3>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
          ...
          <h3 className="text-2xl font-bold text-indigo-600 font-mono mt-2">
            ₹{(summary.totalTaxCollected || 0).toLocaleString('en-IN', { minimumFractionDigits: 2 })}
          </h3>
        </div>
      </div>
